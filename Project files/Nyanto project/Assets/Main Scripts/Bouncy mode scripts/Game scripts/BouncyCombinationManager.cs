...
public class BouncyCombinationManager : MonoBehaviour
{
    //reference to UI
    ...
    public static BouncyCombinationManager instance;
    ...
    private IEnumerator CombineCats(GameObject cat1, GameObject cat2)
    {
        ...
        if (cat1Index == BouncyCatGenerator.instance.Cats.Length -1)
        {
        ...
        else
        {
            ...
            GameObject combinedCat = Instantiate(BouncyCatGenerator.instance.Cats[cat1Index+1]) ;
