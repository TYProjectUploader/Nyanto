...
public class BouncyColliderInformer : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        //condition check necessary or else causes bug where 2 cats are spawned if current cat collides with 2 objects or from combine collision
        {
            ...
            BouncyPlayerMovement.instance.canDrop = true; //enable spawning again
            BouncyCatGenerator.instance.SpawnCat(); //spawn next cat when fruit has collided
