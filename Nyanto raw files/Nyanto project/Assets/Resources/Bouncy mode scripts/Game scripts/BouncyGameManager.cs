...
public class BouncyGameManager : MonoBehaviour
{
    public static BouncyGameManager instance;
    [Header("---General UI---")]
    ...
    void Start()
    {
        ...
        highscore.text = PlayerPrefs.GetInt("BouncyHighScore", 0).ToString();
    }
    public void GameOver()
    {
        ...
        BouncyCatGenerator.instance.currentCat.SetActive(false);
        BouncyPlayerMovement.instance.aimLine.SetActive(false);
    ...
    private void ActivateGameOverScreen()
    {
        ...
        if (BouncyCombinationManager.instance.Score > PlayerPrefs.GetInt("BouncyHighScore", 0))
        {
            highScoreAlert.SetActive(true);
            PlayerPrefs.SetInt("BouncyHighScore", BouncyCombinationManager.instance.Score);
        }
    }
